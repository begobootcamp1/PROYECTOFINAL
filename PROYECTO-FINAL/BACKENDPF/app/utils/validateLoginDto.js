//para validar el email y el password cuando hacemos login, nos ahorramos consultas y conexiones
...
const validateLoginDto = (req, res, next) => {
  ...
  if (!isDTOValid)
    return res
      .status(400)
      .send(ajv.errorsText(validate.errors, { separator: "\n" })); ///n es un salto de línea para que salga cada mensaje en su línea
